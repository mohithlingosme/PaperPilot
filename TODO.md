- [ ] Add/confirm branching model: main, develop, feature/*, hotfix/*
- [ ] Add .github/PULL_REQUEST_TEMPLATE.md
- [ ] Add .github/CODEOWNERS
- [ ] Add .github/ISSUE_TEMPLATE/bug.yml
- [ ] Add .github/ISSUE_TEMPLATE/feature.yml
- [ ] Add .github/ISSUE_TEMPLATE/security.yml
- [ ] Update CONTRIBUTING.md with branch naming rules, PR checklist, review requirements, commit convention rules
- [ ] Provide docs/BRANCHING.md and docs/RELEASING.md
- [ ] Verify files exist and are consistent
=======
